...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		tdcli.sendMessage(arg.chat_id, "", 0, 'User_ ['..user_name..'] \n _ID_ ['..data.id_..']*\n📌¦_is banned _', 0, "md")
   else
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا لا يمكن حظر الادمنيه , "md")
         end
     end
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا لا يمكن حظر الادمنيه", 0, "md")
       end
     end
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا لا يمكن حضر الادمنيه", 0, "md")
        end
     end
if is_gbanned(data.id_) then
   if not lang then
...
tdcli_function ({
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "هذا ادمن لا يمكن حظره ", 0, "md")
   end
  else
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا لا يمكن مسح رسائل الادمنيه ", 0, "md")
   end
  else
tdcli.deleteMessagesFromUser(data.chat_id_, data.sender_user_id_, dl_cb, nil)
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_All_ *messages* _of_*[ "..data.sender_user_id_.." ]* _has been_ *deleted*", 0, "md")
      elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "تم مسح رسائل العضو [ "..data.sender_user_id_.." ]* *تم مسحها 🗑*", 0, "md")
       end
    end
  end
else
    if lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "العضو غير موجود في هذه المجموعه", 0, "md")
   else
...
user_name = check_markdown(data.title_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا الايمكن حضر الادمنيه ", 0, "md")
         end
     end
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
...
if not is_gbanned(data.id_) then
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "عفوا الا يمكن طرد الادمنيه ", 0, "md")
   end
  else
     kick_user(data.id_, arg.chat_id)
     end
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "لا يمكن مسح رسائل الادمنيه ", 0, "md")
   end
  else
...
local function safil(msg, matches)
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   elseif lang then
     tdcli.sendMessage(msg.chat_id_, "", 0, "الا يمكن طرد الادمنيه", 0, "md")
         end
     else
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.chat_id_, matches[2]) then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "لا يمكن حضر الادمنيه", 0, "md")
        end
     end
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
    ...
    if not lang then
					...
					return "لا يوجد مستخدمين محضورين عام هنا "
             end
				end

...
if not lang then
 ...
 return 'عزيزي المطور هذه المجموعه تم تفعيلها'
  end
end
...
local lang = redis:get(hash)
 ...
 return 'عزيزي المطور هذه المجموعه تم تعطيلها'
end
end
...
local lang = redis:get(hash)
  ...
  if not lang then
    ...
    return  "المجموعه لم يتم تفعيلها  راسل المطور ليقوم بتفعيلها "
  end
 end
...
return  "المجموعه خاليه من الادمنيه "
  end
end
if not lang then
...
🔹➖➖🔹➖➖🔹➖➖🔹
‎📌¦ مطور الـسـورس : @SAFIL_DEV
‎📌¦ قناه الـسـورس : @SAFIL_CH
